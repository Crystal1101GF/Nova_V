...
def main(config: dict):
    ...
    base_n_samples = 1400  # Optimized: proven pattern for high scores (more iterations, faster learning)
            ...
            if iteration == 1:
                ...
                if score_improvement_rate > 0.05:
                    ...
                    if has_very_high_score or is_very_late_stage:
                        ...
                        n_synthon_tight = int(n_samples * 0.08)  # 10% of 70%
                        ...
                        n_synthon_medium = int(n_samples * 0.22)  # 30% of 70%
                        ...
                        n_synthon_broad = int(n_samples * 0.22)  # 30% of 70%
